...
https://archive.org
Search: "The Fellowship of the Ring" Tolkien
Any complete plain-text edition of Book 1 is suitable for replication. The analysis in the paper covers the full text of The Fellowship of the Ring (~190,000 words).
Formatting note
The text used in the paper was sourced from a scanned edition and contains double-spaced word formatting (e.g., When  Mr.  Bilbo). This does not affect results — the tokenizer splits on whitespace and is insensitive to spacing width. A clean digital edition will produce equivalent output.
Preparing the file
Save the text as a plain .txt file encoded in UTF-8:
